# Generated by Django 3.1.7 on 2021-05-07 20:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CollegeCourses',
            fields=[
                ('collegecourseId', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            ...
            name='courseId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='collegeapp.courses'),
        ),
        migrations.AddField(
            model_name='collegecourses',
            name='userId',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='collegeapp.collegeuser'),
        ),
    ]
